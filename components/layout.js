...
// ── AI FAB + CRM Copilot: REMOVED. The Copilot now lives in the combined
//    Staff-Chat + Copilot bubble (admin/js/staff-chat.js, mounted app-wide by
//    auth-guard.js). The AI Agent stats tab is still reachable via the sidebar.
